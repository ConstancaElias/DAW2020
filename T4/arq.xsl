...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ARQELEM" mode="indice">
        ...
        <li>
            <a href="arqs/{count(preceding-sibling::*)+1}"> <!-- para a pag do doc que vamos gerar -->
    ...
    <xsl:template match="ARQELEM">
        ...
        <xsl:result-document href="site/arqs/arq{count(preceding-sibling::*)+1}.html">
            ...
            <html>
                ...
                <body>
                    ...
                    <address>
                        [<a href="index.html#{count(preceding-sibling::*)+1}">Voltar à pagina principal</a>]
                    </address>
                </body>
            </html>
